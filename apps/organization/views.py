...
class AddFavView(View):
    ...
    def post(self, request):
        ...
        if exist_record:
            ...
            return JsonResponse({'status': 'success', 'msg': 'cancel collect'})
        else:
            if int(fav_id) > 0 and  int(fav_type) in [1, 2, 3] :
                ...
                return JsonResponse({'status': 'success', 'msg': 'collect success'})
            else:
                return JsonResponse({'status': 'fail', 'msg': 'collect fail'})
