...
from .views import CourseListView, CourseRecommendView, VideoPlayView, CourseDetailView, CourseInfoView, CourseCommentView, AddCommentView
...
urlpatterns = [
    ...
    url(r'recommend/', CourseRecommendView.as_view(), name='course_recommend'),
